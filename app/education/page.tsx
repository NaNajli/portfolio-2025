...
<div className="min-h-screen px-4 ">
  <div>
    ...
    <ul className='text-xl text-center space-y-4 mt-40'>
     <li>▫️ Certificación en Desarrollo Web (2025) BYU</li>
     <li>▫️ Licenciatura en Desarrollo de Software (2023 - presente) BYU-Pathway Worldwide - Brigham Young University - Idaho</li>
     <li> ▫️ Certificado en Programación Web e Informática (2024) BYU</li>
     <li> ▫️ Curso de Testing Manual Ágil con Herramientas (2023) Universidad Tecnológica Nacional (UTN)</li>  
    </ul>
  </div>
</div>
