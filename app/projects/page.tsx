...
export default function Projects() {
  ...
  <>
    ...
    <p className="mt-2 text-sm ">Aplicación web dinámica desarrollada con HTML, CSS y JavaScript, integrando patrones de diseño, validaciones y operaciones CRUD con base de datos relacional.Durante el proceso, se aplicaron buenas prácticas de colaboración en equipo, resolución de problemas y gestión de entregas</p>
   </div>
   <div className="group w-[230px] md:w-[260px] transition-transform hover:scale-105 rounded-lg overflow-hidden shadow-md p-6 ">
   <h2 className={`${italiana.className} text-4xl sm:text-3xl text-center font-extrabold tracking-tight drop-shadow-md m-3`}>Portfolio 2024</h2>
    ...
    <p className="mt-2 text-sm ">Proyecto Personal.Aplicación construida con tecnologías web fundamentales HTML, CSS, JavaScript. El enlace fue implementado mediante GitHub Pages para su despliegue público</p> 
     </div>
    <div className="group w-[230px] md:w-[260px] transition-transform hover:scale-105 rounded-lg overflow-hidden shadow-md p-6 ">
    ...
    <p className="mt-2 text-sm ">Desarrollamos una plataforma web para la Incubadora del NOC utilizando Angular, Node.js y MySQL, orientada a la gestión integral de cursos de capacitación. El sistema permite administrar inscripciones, asistencias, pagos, docentes y publicaciones institucionales. Mi rol principal fue como desarrolladora backend</p>
    </div>
    <div className="group w-[230px] md:w-[260px] transition-transform hover:scale-105 rounded-lg overflow-hidden shadow-md p-6 ">
    <h2 className={`${italiana.className} text-4xl sm:text-3xl text-center font-extrabold tracking-tight drop-shadow-md m-3`}>Concesionario de coches ficticio</h2>
    <Link href="https://web-backend-zscp.onrender.com/" className='bg-white'> <Image className='' src="/pagecars.webp" alt="Concesionario de coches" width={1143} height={1210}/></Link>
     <p className="mt-2 text-sm"> Durante 7 semanas Desarrolle una dinámica página web utilizando MVC modelo. Node.js para el backend en
     JavaScript, y persistencia de datos con PostgreSQL gestionado a través de PgAdmin. El proyecto fue versionado y
     desplegado utilizando GitHub y Render. Conté con el apoyo de un equipo de estudio para la resolución de desafíos
     técnicos</p>
     </div>
